import { AdditionExpressionData, ExponentExpressionData, RootExpressionData } from '../../math-components/expression-data/expressionData';
...
describe('PseudoUnitTests-Puzzles', () => {
  ...
  it('Should accepts and reject exponent values ', () => {
    ...
    const invalid = new AdditionExpressionData(exponentPuzzle.target2.value, 4);
