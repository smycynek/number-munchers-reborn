...
describe('PseudoUnitTests-Puzzles', () => {
  ...
  it('Should accepts and reject subtraction values ', () => {
    ...
    const valid = new SubtractionExpressionData(subtractionPuzzle.target1.value, 0);
    const invalid = new SubtractionExpressionData(subtractionPuzzle.target1.value, 1);
  ...
  it('Should accepts and reject multiple values ', () => {
    ...
    const valid = new MixedNumberExpressionData(multiplesPuzzle.target1.value * 3, 0, 0);
    const invalid = new MixedNumberExpressionData(multiplesPuzzle.target1.value * 1.5, 0, 0);
  ...
  it('Should accepts and reject between values', () => {
    ...
    const valid = new MixedNumberExpressionData(betweenPuzzle.target1.value + 1, 0, 0);
    const invalid = new MixedNumberExpressionData(betweenPuzzle.target1.value - 1, 0, 0);
  ...
  it('Should accepts and reject outside exclusive values', () => {
    ...
    const valid = new MixedNumberExpressionData(oePuzzle.target1.value - 1, 0, 0);
    const invalid = new MixedNumberExpressionData(oePuzzle.target1.value + 1, 0, 0);
  ...
  it('Should accepts and reject between inclusive values', () => {
    ...
    const invalid = new MixedNumberExpressionData(bePuzzle.target1.value - 1, 0, 0);
